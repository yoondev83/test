...
const DEFAULT_SCALE_VALUE = isNaN(document.location.search.slice(-4))?"auto":Number(document.location.search.slice(-4));
exports.DEFAULT_SCALE_VALUE = DEFAULT_SCALE_VALUE;
const DEFAULT_SCALE = isNaN(document.location.search.slice(-4))?1.0: Number(document.location.search.slice(-4));
...
var _pdf_find_bar = __webpack_require__(11);
var _pdf_find_controller = __webpack_require__(12);
var _pdf_layer_viewer = __webpack_require__(14);
var _pdf_outline_viewer = __webpack_require__(16);
var _pdf_rendering_queue = __webpack_require__(17);
var _pdf_scripting_manager = __webpack_require__(18);
var _pdf_sidebar = __webpack_require__(19);
...
const PDFViewerApplication = {
  ...
  async _initializeViewerComponents() {
    var _appConfig$sidebar, _appConfig$sidebar2, _appConfig$sidebar3;
    const {
      appConfig,
      externalServices
    } = this;
    ...
    if ((_appConfig$sidebar3 = appConfig.sidebar) !== null && _appConfig$sidebar3 !== void 0 && _appConfig$sidebar3.layersView) {
  ...
  load(pdfDocument) {
    ...
    firstPagePromise.then(pdfPage => {
      ...
      Promise.all([_ui_utils.animationStarted, pageLayoutPromise, pageModePromise, openActionPromise]).then(async _ref3 => {
...
{
  const HOSTED_VIEWER_ORIGINS = ["null", "http://mozilla.github.io", "https://mozilla.github.io", "https://mobis--ps.sandbox.lightning.force.com", "https://mobis.lightning.force.com"];
...
function webViewerInitialized() {
  ...
  let file;                                             // this is to remove &scale=x.xx from url
  const queryString = document.location.search.substring(1, document.location.search.length-11);
...
function webViewerClick(evt) {
  var _PDFViewerApplication22, _appConfig$toolbar3, _appConfig$secondaryT2;
  ...
  if (PDFViewerApplication.pdfViewer.containsElement(evt.target) || (_appConfig$toolbar3 = appConfig.toolbar) !== null && _appConfig$toolbar3 !== void 0 && _appConfig$toolbar3.container.contains(evt.target) && evt.target !== ((_appConfig$secondaryT2 = appConfig.secondaryToolbar) === null || _appConfig$secondaryT2 === void 0 ? void 0 : _appConfig$secondaryT2.toggleButton)) {
...
var _pdfjsLib = __webpack_require__(6);
var _ui_utils = __webpack_require__(1);
var _l10n_utils = __webpack_require__(24);
...
var _pdfjsLib = __webpack_require__(6);
var _ui_utils = __webpack_require__(1);
var _annotation_editor_layer_builder = __webpack_require__(26);
var _annotation_layer_builder = __webpack_require__(27);
var _app_options = __webpack_require__(2);
var _l10n_utils = __webpack_require__(24);
var _struct_tree_layer_builder = __webpack_require__(28);
...
var _app = __webpack_require__(4);
var _document$blockUnbloc, _document;
const pdfjsVersion = '3.4.4';
const pdfjsBuild = '2ebbeb749';
const AppConstants = {
...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      openFile: null,
      print: null,
      editorFreeTextButton: null,
      editorFreeTextParamsToolbar: null,
      editorInkButton: null,
      editorInkParamsToolbar: null,
      download: null
    },
    secondaryToolbar: {
    ...
    annotationEditorParams: {
      editorFreeTextFontSize: null,
      editorFreeTextColor: null,
      editorInkColor: null,
      editorInkThickness: null,
      editorInkOpacity: null
    },
    printContainer: null,
    openFileInput: null,
